...
class UserValidationTest {
	 @Test
	    public void givenFirstName_WhenProper_ShouldReturnTrue() {
	        ...
	        boolean isValid = userValidator.validateName("Anusha");
	    ...
	    public void givenFirstName_WhenFirstLetterIsSmall_ShouldReturnFalse() {
	        ...
	        UserValidation userValidator = new UserValidation();
	        boolean isNotValid = userValidator.validateName("ajith");
	    ...
	    public void givenFirstName_WhenLesserThanThreeCharacters_ShouldReturnFalse() {
	        ...
	        UserValidation userValidator = new UserValidation();
	        boolean isNotValid = userValidator.validateName("Vy");
	        Assert.assertFalse(isNotValid);
	    ...
	    public void givenLastName_WhenProper_ShouldReturnTrue() {
	        ...
	        UserValidation userValidator = new UserValidation();
	        boolean isValid = userValidator.validateName("Vysakh");
	        Assert.assertTrue(isValid);
	    ...
	    public void givenEmailAddress_WhenProper_ShouldReturnTrue() {
	        ...
	        UserValidation userValidator = new UserValidation();
	        boolean isValid = userValidator.validateEmail("vysakhc14@gmail.com");
	        Assert.assertTrue(isValid);
